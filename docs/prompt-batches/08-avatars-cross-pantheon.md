# Batch 08 — Avatar badges: cross-pantheon roster

Paste each block one at a time, in the same conversation as the existing avatar badge sheet.

## Thor × Thunder Brawler

```
Match the established art style and shield-crest badge frame of the avatar portraits in this conversation.
...
Character: Bastet as a sleek cat-eared goddess lounging with a gold ankh spinning on one claw, dramatic lapis eyeliner, a saucer of milk beside a stack of won gambling chips. Purring smugness.

STYLE: Persona 5 × Hades hybrid illustration — heavy black ink outlines, high-contrast cel shading with painted rim light, lacquer black, vermilion red, imperial gold on off-white aged-parchment background, lapis accent. East Asian character design, wuxia and Chinese-opera costuming reinterpreting Egyptian myth. Confident theatrical expression. Flat graphic background, no photorealism. Clean edges suitable for cutting out as a game asset.
```
...
Character: Amaterasu, radiant sun goddess emerging from cave shadow — one half of the badge in darkness, the other blazing gold. She holds a bronze mirror that reflects her own light forward at the viewer. Sunburst hairpins, a string of magatama beads.

STYLE: Persona 5 × Hades hybrid illustration — heavy black ink outlines, high-contrast cel shading with painted rim light, lacquer black, vermilion red, imperial gold on off-white aged-parchment background, sunrise-gold accent. East Asian character design, wuxia and Chinese-opera costuming reinterpreting Japanese myth. Confident theatrical expression. Flat graphic background, no photorealism. Clean edges suitable for cutting out as a game asset.
```
...
Character: Anansi as a wiry old trickster with a gap-toothed grin. Behind his two real arms rise six extra shadow-arms in spider silhouette, each shadow-hand holding a different playing card, silk threads woven between them like a cat's cradle.

STYLE: Persona 5 × Hades hybrid illustration — heavy black ink outlines, high-contrast cel shading with painted rim light, lacquer black, vermilion red, imperial gold on off-white aged-parchment background. East Asian character design, wuxia and Chinese-opera costuming reinterpreting West African myth. Confident theatrical expression. Flat graphic background, no photorealism. Clean edges suitable for cutting out as a game asset.
```

## Heracles × Tiger-Slayer
...
Character: Heracles as a mountain of a man in the spirit of Wu Song the tiger-slayer — a tiger pelt knotted over one shoulder, hand-wrapped fists, twelve small trophy medallions strung across his chest (one per labor). Cheerful, terrifying grin, cracked knuckles.
...
Character: the three Fates sharing one badge — a young woman spinning red thread, a serene middle-aged woman measuring it across her fingers, and an old woman with gold scissors poised to cut. A single red thread connects all three hands.
...
Character: Charon as a gaunt hooded ferryman with a long lantern-pole oar over his shoulder, a teal ghost-light lantern swinging from its end. A single gold coin is held between his teeth in a grin. Mist and river reeds curl at the badge's lower edge.
